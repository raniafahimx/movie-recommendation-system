...
.stApp {
  background:
    radial-gradient(ellipse at 0% 0%, rgba(69,44,99,0.28) 0%, transparent 15%),
    radial-gradient(ellipse at 100% 0%, rgba(51,0,111,0.22) 0%, transparent 10%),
  ...
  <div class="hero-content">
    ...
    <div class="hero-body">
      <div class="hero-inner">
        ...
        <div class="cta-row">
          <a class="btn-secondary" href="/?page=overview" target="_top">
